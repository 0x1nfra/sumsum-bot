...
Plans:
- [ ] 02-01: Implement NOAA client and location/time-window mapping for supported market types.
- [ ] 02-02: Build edge calculation rules and signal acceptance criteria.
- [ ] 02-03: Persist signal evaluation details for inspection and downstream execution.
...
|-------|----------------|--------|-----------|
| 1. Market Discovery Foundation | 0/3 | Not started | - |
| 2. NOAA Signal Engine | 0/3 | Not started | - |
